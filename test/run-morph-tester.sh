...
pythonbin=/Library/Frameworks/Python.framework/Versions/3.8/bin/python3
runtests="$pythonbin /Users/jackrueter/Dropbox/Github/giellalt/lang-slh/./../giella-core/scripts/morph-test.py"
