...
CONFIG_CLEAN_FILES = giella-slh.pc manifest.toml \
...
ZIP = /usr/bin/zip
abs_builddir = /Users/jackrueter/Dropbox/Github/giellalt/lang-slh
abs_srcdir = /Users/jackrueter/Dropbox/Github/giellalt/lang-slh
...
$(am__aclocal_m4_deps):
giella-slh.pc: $(top_builddir)/config.status $(srcdir)/giella-slh.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
manifest.toml: $(top_builddir)/config.status $(srcdir)/manifest.toml.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
devtools/test_voikkospell_suggestions.sh: $(top_builddir)/config.status $(top_srcdir)/devtools/test_voikkospell_suggestions.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
devtools/test_grammar_checker.sh: $(top_builddir)/config.status $(top_srcdir)/devtools/test_grammar_checker.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
